...
export const teamDepartments: TeamDept[] = [
  {
    title: 'Technical & Engineering Team',
    description: 'Designs and configures the right product specification for every site and project scale.',
    points: [
      'Site assessment and wattage/pole-height recommendations',
      'Custom configuration for large highway and industrial projects',
      'Quality checks on components before dispatch',
    ],
  },
  {
    title: 'Sales & Customer Support',
    description: 'Guides customers through product selection, pricing and order placement.',
    points: [
      'Answers product and pricing enquiries',
      'Prepares customized quotes for bulk and government orders',
      'Coordinates order confirmation and delivery timelines',
    ],
  },
  {
    title: 'Installation & Field Service',
    description: 'Handles on-site installation and commissioning across India.',
    points: [
      'Foundation, pole erection and fixture mounting on-site',
      'Wiring, battery connection and system testing',
      'Final commissioning and handover to the client',
    ],
  },
  {
    title: 'After-Sales & Warranty Support',
    description: 'Provides ongoing maintenance support and warranty service after installation.',
    points: [
      'Warranty claim assistance for eligible products',
      'Troubleshooting and maintenance guidance',
      'Nationwide service support for installed projects',
    ],
  },
];
...
export const productCategories: ProductCategory[] = [
  {
    ...
    heroImage: 'assets/products/real/street-light-real.jpg',
    features: [
  ...
  },
  {
    ...
    heroImage: 'assets/products/real/semi-integrated-real.jpg',
    features: [
  ...
  },
  {
    ...
    heroImage: 'assets/products/real/high-mast-real.jpg',
    features: [
  ...
  },
  {
    ...
    heroImage: 'assets/products/real/flood-light-real.jpg',
    features: [
